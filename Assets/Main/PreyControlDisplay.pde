...
public class PreyControlDisplay extends AnimalControlDisplay implements IMouseEventListener
{
    ...
    protected void CreateMenu()
    {
        ...
        m_PreysNearby.transform().SetLocalPosition(new ZVector(0f, 150f));      
        ...
        m_SplitMultiplier.transform().SetLocalPosition(new ZVector(0f, 225f)); 
        ...
        splitTitleTxt.transform().SetLocalPosition(new ZVector(0f, 275f));
        ...
        m_SplitBar.transform().SetLocalPosition(new ZVector(0f, 325f));
        ...
        m_SplitBlocked.transform().SetLocalPosition(new ZVector(0f, 400f));
